...
const GoGlobal = () => {
  return (
    <section
      className="section mx-auto  max-w-[1200px] text-center text-white"
      id="go-global"
    >
      <div className="grid h-full  grid-cols-1 place-items-center p-s3 md:grid-cols-2 md:p-0 lg:w-[90%]">
        ...
        <div className="mt-s2 flex flex-col items-start justify-start gap-y-6 md:mt-0">
          <h2 data-test="global-potential" className="h2 text-start">
            Unlock your global potential.
          </h2>
          <p
            data-test="international"
            className="text-start text-lg md:text-xl"
          >
