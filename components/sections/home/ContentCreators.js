      ...
      <div className="mx-auto grid w-full grid-cols-1 place-content-center place-items-center gap-s25 p-3">
        {LANDING_PAGE_TYPES.map((itemType, idx) => (
          <div
            ...
            key={idx}
          >
            <div className="flex w-full items-center justify-center md:pr-s18">
              <Image
                src={itemType.image}
            ...
            <div className="flex w-full max-w-[430px] flex-col gap-y-5 p-0">
              <p
                data-test={`${itemType.title}`}
                className="w-full text-4xl font-semibold md:w-5/6 md:text-6xl"
              >
                {itemType.title}
              </p>
              <p
                data-test={`${itemType.description}`}
