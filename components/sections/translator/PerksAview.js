...
const PerksAview = () => {
  return (
    <section className="section m-horizontal mt-s8 lg:mt-s17">
      <div className="items-center grid lg:grid-cols-4">
        ...
        <div className='list' key={`list-${i}`}>
          ...
          <h1 className='title mr-s2 lg:min-w-[140px] lg:text-[100px] lg:mt-s3'>
          <span className="gradient-text gradient-2"> {list.number}</span>
          </h1>
      
          <div className='list-info'>
          <h3 className={`title text-2xl mb-s1`}>{list.title}</h3>
        ...
        <div className="col-span-2 mt-s4 lg:col-span-2 lg:max-w-[550px] lg:my-auto mx-auto">
