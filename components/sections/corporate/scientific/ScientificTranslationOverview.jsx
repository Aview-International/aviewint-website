...
export default function ScientificTranslationOverview() {
  return (
    <section className="section m-horizontal">
      ...
      <p className="body mb-s2 hidden md:mb-s5 md:block md:text-center">
        ...
        projects. We help translate reports, data, and more. Scientific
        translation requires complete accuracy and expertise in the material.
        Our certified translators are here to create the highest quality
        translations for you. We cater to your specific needs so that you can
        reach your goals.
      </p>
      <p className="body mb-s2 md:mb-s5 md:hidden">
        Translating scientific material is the first step to international
        collaboration. At Aview, we take a personalized approach to your
