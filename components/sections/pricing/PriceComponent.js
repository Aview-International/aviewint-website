...
const PriceComponent = ({ item }) => {
  return (
    <>
      <div className={`relative h-[820px] flex flex-col items-center justify-between py-s4 px-s3 bg-white-transparent rounded-2xl cursor-pointer`}>
            <div className="flex flex-col gap-y-4 items-center">
                ...
                <p className="w-[192px] text-center">{item.description}</p>
            </div>
            <div>
            {
