    ...
    <div className="mt-s8 flex flex-col md:flex-row" data-aos="zoom-in-up">
      <div className="flex w-full flex-col items-start justify-center gap-3 rounded-2xl border-2 p-s2">
        <p>
          ...
          an AI voice tailored to your own voice. Feel free to do more to
          achieve a more accurate voice.
        </p>
        <div className="mx-auto mt-s2 w-[200px]">
          <OnboardingButton theme="light" onClick={() => setOption('record')}>
            Record Voice Sample
          </OnboardingButton>
        </div>
      </div>
      ...
      <div className="ml-s2 flex w-full flex-col items-start justify-center gap-3 rounded-2xl border-2 p-s2">
        <p>
          Uploaded pre-recorded voice samples of you speaking clearly that is
          devoid of noise and loud background. Upload at least 5 samples to
          achieve a better voice cloning effect.
        </p>
        <div className="mx-auto mt-s2 w-[200px]">
          <OnboardingButton theme="light" onClick={() => setOption('upload')}>
            Upload Voice Sample
          </OnboardingButton>
        </div>
      </div>
