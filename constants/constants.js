...
export const VOICEPROMPTS = [
  ...
  'In the digital era, an unprecedented surge in social media content creation is reshaping online landscapes. With each passing day, a myriad of posts, images, and videos permeate the digital sphere, contributing to the exponential expansion of the social media content ecosystem.',
];
